base: {  }
collision_head_1_origin(base): { pose: [0.11, 0, 0.75, 1, 0, 0, 0] }
collision_head_2_origin(base): { pose: [0.11, 0, 0.75, 1, 0, 0, 0] }
...
left_torso_itb_fixed_origin(torso): { pose: [-0.08897, 0.15593, 0.389125, 3.2758e-05, -3.2758e-05, 0.707107, 0.707107] }
right_torso_itb_fixed_origin(torso): { pose: [-0.08897, -0.15593, 0.389125, 0.707107, 0.707107, 0, 0] }
head_pan_origin(torso): { pose: [0.06, 0, 0.686, 1, 0, 0, 0] }
sonar_s0_origin(torso): { pose: [0.0947, 0, 0.817, 1, 0, 0, 0] }
...
head_0(head): { pose: [0, 0, 0.00953, 1, 0, 0, 0], shape: mesh, color: [0.2, 0.2, 0.2, 1], mesh: <baxter_description/meshes/head/H0.ply>, visual: True }
...
screen_0(screen): { pose: [0, -0.00953, -0.0347, 0.707107, 0, -0.707107, 0], shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <baxter_description/meshes/head/H1.ply>, visual: True }
display_joint_origin(screen): { pose: [0, -0.016, 0, 1, 0, 0, 0] }
...
right_s1_origin(right_upper_shoulder): { pose: [0.069, 0, 0.27035, 0.707107, -0.707107, 0, 0] }
...
left_s1_origin(left_upper_shoulder): { pose: [0.069, 0, 0.27035, 0.707107, -0.707107, 0, 0] }
...
left_e0_origin(left_lower_shoulder): { pose: [0.102, 0, 0, 0.5, 0.5, 0.5, 0.5] }
left_e0_fixed_origin(left_lower_shoulder): { pose: [0.107, 0, 0, 0.5, 0.5, 0.5, 0.5] }
...
right_e1_origin(right_upper_elbow): { pose: [0.069, 0, 0.26242, 0.5, -0.5, -0.5, -0.5] }
...
left_e1_origin(left_upper_elbow): { pose: [0.069, 0, 0.26242, 0.5, -0.5, -0.5, -0.5] }
...
right_w0_origin(right_lower_elbow): { pose: [0.10359, 0, 0, 0.5, 0.5, 0.5, 0.5] }
right_w0_fixed_origin(right_lower_elbow): { pose: [0.088, 0, 0, 0.5, 0.5, 0.5, 0.5] }
...
left_w0_origin(left_lower_elbow): { pose: [0.10359, 0, 0, 0.5, 0.5, 0.5, 0.5] }
left_w0_fixed_origin(left_lower_elbow): { pose: [0.088, 0, 0, 0.5, 0.5, 0.5, 0.5] }
...
right_w0_to_itb_fixed_origin(right_upper_forearm): { pose: [-0.0565, 0, 0.12, 0.5, -0.5, -0.5, 0.5] }
right_w1_origin(right_upper_forearm): { pose: [0.01, 0, 0.2707, 0.5, -0.5, -0.5, -0.5] }
...
left_w0_to_itb_fixed_origin(left_upper_forearm): { pose: [-0.0565, 0, 0.12, 0.5, -0.5, -0.5, 0.5] }
left_w1_origin(left_upper_forearm): { pose: [0.01, 0, 0.2707, 0.5, -0.5, -0.5, -0.5] }
...
right_w2_origin(right_lower_forearm): { pose: [0.115975, 0, 0, 0.5, 0.5, 0.5, 0.5] }
...
left_w2_origin(left_lower_forearm): { pose: [0.115975, 0, 0, 0.5, 0.5, 0.5, 0.5] }
...
right_hand_camera_origin(right_hand_127): { pose: [0.03825, 0.012, 0.015355, 0.707107, 0, 0, -0.707107] }
right_hand_camera_axis_origin(right_hand_127): { pose: [0.03825, 0.012, 0.015355, 1, 0, 0, 0] }
right_hand_range_origin(right_hand_127): { pose: [0.032, -0.020245, 0.0288, 0.5, -0.5, -0.5, -0.5] }
right_hand_accelerometer_origin(right_hand_127): { pose: [0.00198, 0.000133, -0.0146, 1, 0, 0, 0] }
right_gripper_base_origin(right_hand_127): { pose: [0, 0, 0.025, 1, 0, 0, 0] }
left_hand_camera_origin(left_hand_128): { pose: [0.03825, 0.012, 0.015355, 0.707107, 0, 0, -0.707107] }
left_hand_camera_axis_origin(left_hand_128): { pose: [0.03825, 0.012, 0.015355, 1, 0, 0, 0] }
left_hand_range_origin(left_hand_128): { pose: [0.032, -0.020245, 0.0288, 0.5, -0.5, -0.5, -0.5] }
left_hand_accelerometer_origin(left_hand_128): { pose: [0.00198, 0.000133, -0.0146, 1, 0, 0, 0] }
left_gripper_base_origin(left_hand_128): { pose: [0, 0, 0.025, 1, 0, 0, 0] }
...
l_gripper_r_finger_joint_origin(left_gripper_base_158): { pose: [0, 0.0015, 0.02, 1, 0, 0, 0] }
...
r_gripper_l_finger_0(r_gripper_l_finger): { pose: [0, 0, 0, -1.03412e-13, 0, 0, -1], shape: mesh, color: [0.8, 0.8, 0.8], mesh: <rethink_ee_description/meshes/electric_gripper/fingers/extended_narrow.ply>, visual: True }
r_gripper_l_finger_tip_joint_origin(r_gripper_l_finger): { pose: [0, 0.01725, 0.1127, 1, 0, 0, 0] }
...
r_gripper_r_finger_tip_joint_origin(r_gripper_r_finger): { pose: [0, -0.01725, 0.1127, 1, 0, 0, 0] }
l_gripper_l_finger_0(l_gripper_l_finger): { pose: [0, 0, 0, -1.03412e-13, 0, 0, -1], shape: mesh, color: [0.8, 0.8, 0.8], mesh: <rethink_ee_description/meshes/electric_gripper/fingers/extended_narrow.ply>, visual: True }
l_gripper_l_finger_tip_joint_origin(l_gripper_l_finger): { pose: [0, 0.01725, 0.1127, 1, 0, 0, 0] }
...
l_gripper_r_finger_tip_joint_origin(l_gripper_r_finger): { pose: [0, -0.01725, 0.1127, 1, 0, 0, 0] }
...
r_gripper_l_finger_tip_0(r_gripper_l_finger_tip): { pose: [0, 0, 0, -1.03412e-13, 0, 0, 1], shape: mesh, color: [0.8, 0.8, 0.8], mesh: <rethink_ee_description/meshes/electric_gripper/fingers/half_round_tip.ply>, visual: True }
...
l_gripper_l_finger_tip_0(l_gripper_l_finger_tip): { pose: [0, 0, 0, -1.03412e-13, 0, 0, 1], shape: mesh, color: [0.8, 0.8, 0.8], mesh: <rethink_ee_description/meshes/electric_gripper/fingers/paddle_tip.ply>, visual: True }
