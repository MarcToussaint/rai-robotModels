...
right_gripper_base_0(right_gripper_base): { rel: [0, 0, 0, -7.3123e-14, 7.3123e-14, 0.707107, 0.707107], shape: mesh, color: [0.8, 0.8, 0.8], mesh: 'electric_gripper/electric_gripper_base.ply', visual: True }
...
left_gripper_base_0(left_gripper_base): { rel: [0, 0, 0, -7.3123e-14, 7.3123e-14, 0.707107, 0.707107], shape: mesh, color: [0.8, 0.8, 0.8], mesh: 'electric_gripper/electric_gripper_base.ply', visual: True }
