...
torso(torso_t0): {  }
collision_head_link_1(collision_head_1): {  }
collision_head_link_2(collision_head_2): {  }
torso_0(torso): { shape: mesh, color: [0.2, 0.2, 0.2, 1], mesh: <torso/base_link.ply>, visual: True }
...
left_torso_itb(left_torso_itb_fixed): {  }
right_torso_itb(right_torso_itb_fixed): {  }
head(head_pan): {  }
sonar_ring(sonar_s0): {  }
right_arm_mount(right_torso_arm_mount): {  }
left_arm_mount(left_torso_arm_mount): {  }
pedestal(pedestal_fixed): {  }
head_0(head): { rel: [0, 0, 0.00953, 1, 0, 0, 0], shape: mesh, color: [0.2, 0.2, 0.2, 1], mesh: <head/H0.ply>, visual: True }
...
pedestal_0(pedestal): { shape: mesh, color: [0.2, 0.2, 0.2, 1], mesh: <base/PEDESTAL.ply>, visual: True }
dummyhead1(dummy): {  }
...
screen(head_nod): {  }
head_camera_47(head_camera): {  }
right_upper_shoulder(right_s0): {  }
left_upper_shoulder(left_s0): {  }
screen_0(screen): { rel: [0, -0.00953, -0.0347, 0.707107, 0, -0.707107, 0], shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <head/H1.ply>, visual: True }
display_joint_origin(screen): { rel: [0, -0.016, 0, 1, 0, 0, 0] }
right_upper_shoulder_0(right_upper_shoulder): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <upper_shoulder/S0.ply>, visual: True }
right_s1_origin(right_upper_shoulder): { rel: [0.069, 0, 0.27035, 0.707107, -0.707107, 0, 0] }
left_upper_shoulder_0(left_upper_shoulder): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <upper_shoulder/S0.ply>, visual: True }
...
right_lower_shoulder_0(right_lower_shoulder): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <lower_shoulder/S1.ply>, visual: True }
...
left_lower_shoulder_0(left_lower_shoulder): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <lower_shoulder/S1.ply>, visual: True }
...
right_upper_elbow_visual(right_e0_fixed): {  }
left_upper_elbow(left_e0): {  }
left_upper_elbow_visual(left_e0_fixed): {  }
right_upper_elbow_0(right_upper_elbow): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <upper_elbow/E0.ply>, visual: True }
right_e1_origin(right_upper_elbow): { rel: [0.069, 0, 0.26242, 0.5, -0.5, -0.5, -0.5] }
left_upper_elbow_0(left_upper_elbow): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <upper_elbow/E0.ply>, visual: True }
...
right_lower_elbow_0(right_lower_elbow): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <lower_elbow/E1.ply>, visual: True }
...
left_lower_elbow_0(left_lower_elbow): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <lower_elbow/E1.ply>, visual: True }
...
right_upper_forearm_visual(right_w0_fixed): {  }
left_upper_forearm(left_w0): {  }
left_upper_forearm_visual(left_w0_fixed): {  }
right_upper_forearm_0(right_upper_forearm): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <upper_forearm/W0.ply>, visual: True }
...
left_upper_forearm_0(left_upper_forearm): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <upper_forearm/W0.ply>, visual: True }
...
right_arm_itb(right_w0_to_itb_fixed): {  }
right_lower_forearm(right_w1): {  }
left_arm_itb(left_w0_to_itb_fixed): {  }
left_lower_forearm(left_w1): {  }
right_lower_forearm_0(right_lower_forearm): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <lower_forearm/W1.ply>, visual: True }
right_w2_origin(right_lower_forearm): { rel: [0.115975, 0, 0, 0.5, 0.5, 0.5, 0.5] }
left_lower_forearm_0(left_lower_forearm): { shape: mesh, color: [0.5, 0.1, 0.1, 1], mesh: <lower_forearm/W1.ply>, visual: True }
...
left_wrist(left_w2): {  }
right_wrist_0(right_wrist): { shape: mesh, color: [0.1, 0.1, 0.1, 1], mesh: <wrist/W2.ply>, visual: True }
right_hand_origin(right_wrist): { rel: [0, 0, 0.11355, 1, 0, 0, 0] }
left_wrist_0(left_wrist): { shape: mesh, color: [0.1, 0.1, 0.1, 1], mesh: <wrist/W2.ply>, visual: True }
...
right_hand_127(right_hand): {  }
left_hand_128(left_hand): {  }
...
right_hand_camera_149(right_hand_camera): {  }
right_hand_camera_axis_150(right_hand_camera_axis): {  }
right_hand_range_151(right_hand_range): {  }
right_hand_accelerometer_152(right_hand_accelerometer): {  }
right_gripper_base_153(right_gripper_base): {  }
left_hand_camera_154(left_hand_camera): {  }
left_hand_camera_axis_155(left_hand_camera_axis): {  }
left_hand_range_156(left_hand_range): {  }
left_hand_accelerometer_157(left_hand_accelerometer): {  }
left_gripper_base_158(left_gripper_base): {  }
...
right_gripper_base_0(right_gripper_base_153): { rel: [0, 0, 0, -7.3123e-14, 7.3123e-14, 0.707107, 0.707107], shape: mesh, color: [0.8, 0.8, 0.8], mesh: <electric_gripper/electric_gripper_base.ply>, visual: True }
...
left_gripper_base_0(left_gripper_base_158): { rel: [0, 0, 0, -7.3123e-14, 7.3123e-14, 0.707107, 0.707107], shape: mesh, color: [0.8, 0.8, 0.8], mesh: <electric_gripper/electric_gripper_base.ply>, visual: True }
...
right_gripper(right_endpoint): {  }
r_gripper_l_finger(r_gripper_l_finger_joint): {  }
r_gripper_r_finger(r_gripper_r_finger_joint): {  }
left_gripper(left_endpoint): {  }
l_gripper_l_finger(l_gripper_l_finger_joint): {  }
l_gripper_r_finger(l_gripper_r_finger_joint): {  }
r_gripper_l_finger_0(r_gripper_l_finger): { rel: [0, 0, 0, -1.03412e-13, 0, 0, -1], shape: mesh, color: [0.8, 0.8, 0.8], mesh: <electric_gripper/fingers/extended_narrow.ply>, visual: True }
r_gripper_l_finger_tip_joint_origin(r_gripper_l_finger): { rel: [0, 0.01725, 0.1127, 1, 0, 0, 0] }
r_gripper_r_finger_0(r_gripper_r_finger): { shape: mesh, color: [0.8, 0.8, 0.8], mesh: <electric_gripper/fingers/extended_narrow.ply>, visual: True }
r_gripper_r_finger_tip_joint_origin(r_gripper_r_finger): { rel: [0, -0.01725, 0.1127, 1, 0, 0, 0] }
l_gripper_l_finger_0(l_gripper_l_finger): { rel: [0, 0, 0, -1.03412e-13, 0, 0, -1], shape: mesh, color: [0.8, 0.8, 0.8], mesh: <electric_gripper/fingers/extended_narrow.ply>, visual: True }
l_gripper_l_finger_tip_joint_origin(l_gripper_l_finger): { rel: [0, 0.01725, 0.1127, 1, 0, 0, 0] }
l_gripper_r_finger_0(l_gripper_r_finger): { shape: mesh, color: [0.8, 0.8, 0.8], mesh: <electric_gripper/fingers/extended_narrow.ply>, visual: True }
...
r_gripper_l_finger_tip(r_gripper_l_finger_tip_joint): {  }
r_gripper_r_finger_tip(r_gripper_r_finger_tip_joint): {  }
l_gripper_l_finger_tip(l_gripper_l_finger_tip_joint): {  }
l_gripper_r_finger_tip(l_gripper_r_finger_tip_joint): {  }
r_gripper_l_finger_tip_0(r_gripper_l_finger_tip): { rel: [0, 0, 0, -1.03412e-13, 0, 0, 1], shape: mesh, color: [0.8, 0.8, 0.8], mesh: <electric_gripper/fingers/half_round_tip.ply>, visual: True }
r_gripper_r_finger_tip_0(r_gripper_r_finger_tip): { shape: mesh, color: [0.8, 0.8, 0.8], mesh: <electric_gripper/fingers/half_round_tip.ply>, visual: True }
l_gripper_l_finger_tip_0(l_gripper_l_finger_tip): { rel: [0, 0, 0, -1.03412e-13, 0, 0, 1], shape: mesh, color: [0.8, 0.8, 0.8], mesh: <electric_gripper/fingers/paddle_tip.ply>, visual: True }
l_gripper_r_finger_tip_0(l_gripper_r_finger_tip): { shape: mesh, color: [0.8, 0.8, 0.8], mesh: <electric_gripper/fingers/paddle_tip.ply>, visual: True }