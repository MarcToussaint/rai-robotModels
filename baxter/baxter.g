...
#shape (head): { shape: box, size: [0.218, 0.16, 0.001], Q: "T -0.0157421 1.40048e-14 -0.119839 0.154854 -0.689942 -0.689942 0.154854 ", color: [0, 0, 0, 1] }
...
(head): { shape: box, size: [0.27, 0.19, 0.03], Q: [-0.0157421, 0, -0.119839, 0.154854, -0.689942, -0.689942, 0.154854], color: [1, 0, 0] }
...
base_footprint_1(base_footprint): { shape: marker, size: [.1] } #marker
Edit base(base_footprint): { joint: rigid, pre: "t(0 0 1)" }
torso_lift_link_0 (base): { shape: marker, size: [.3] }
...
baxterR (right_wrist): { Q: "T d(-90 0 1 0) d(-90 0 0 1) t(0 0 -.26)", shape: marker, size: [.1], color: [1, 1, 0] }
baxterL (left_wrist): { Q: "T d(-90 0 1 0) d(-90 0 0 1) t(0 0 -.26)", shape: marker, size: [.1], color: [1, 1, 0] }
