...
frame (panda_hand_joint)	{ shape:capsule color:[ 0.8 0.2 0.2 0.2 ] size:[.15 .06] Q:<d(90 1 0 0) t(0 .01 .0)>, noVisual, contact:-2  }

frame (panda_finger_joint1)	{ shape:capsule color:[ 0.8 0.2 0.2 0.2 ] size:[.03 .015] Q:<d(0 1 0 0) t(.015 .0 .03)>, noVisual, contact:-2  }
frame (panda_finger_joint2)	{ shape:capsule color:[ 0.8 0.2 0.2 0.2 ] size:[.03 .015] Q:<d(0 1 0 0) t(.015 .0 .03)>, noVisual, contact:-2  }
