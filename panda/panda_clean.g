frame panda_link0 	{  }
frame panda_link0_1(panda_link0) 	{  shape:mesh  mesh:'meshes/visual/link0.ply'  visual, }
...
frame panda_link1_1(panda_joint1) 	{  shape:mesh  mesh:'meshes/visual/link1.ply' Q:<-0 -0 -0 -0.707107 0 -0.707107 0>  visual, }
...
frame panda_link2_1(panda_joint2) 	{  shape:mesh  mesh:'meshes/visual/link2.ply' Q:<-0 -0 -0 -0.707107 0 -0.707107 0>  visual, }
...
frame panda_link3_1(panda_joint3) 	{  shape:mesh  mesh:'meshes/visual/link3.ply' Q:<-0 -0 -0 -0.707107 0 -0.707107 0>  visual, }
...
frame panda_link4_1(panda_joint4) 	{  shape:mesh  mesh:'meshes/visual/link4.ply' Q:<-0 -0 -0 -0.707107 0 -0.707107 0>  visual, }
...
frame panda_link5_1(panda_joint5) 	{  shape:mesh  mesh:'meshes/visual/link5.ply' Q:<-0 -0 -0 -0.707107 0 -0.707107 0>  visual, }
...
frame panda_link6_1(panda_joint6) 	{  shape:mesh  mesh:'meshes/visual/link6.ply' Q:<-0 -0 -0 -0.707107 0 -0.707107 0>  visual, }
...
frame panda_link7_1(panda_joint7) 	{  shape:mesh  mesh:'meshes/visual/link7.ply' Q:<-0 -0 -0 -0.707107 0 -0.707107 0>  visual, }
...
frame panda_hand_1(panda_hand_joint) 	{  shape:mesh  mesh:'meshes/visual/hand.ply'  visual, }
...
frame panda_leftfinger_1(panda_finger_joint1) 	{  shape:mesh  mesh:'meshes/visual/finger.ply' Q:<-0 -0 -0 -0.707107 0 0 0.707107>  visual, }
...
frame panda_rightfinger_1(panda_finger_joint2) 	{  shape:mesh  mesh:'meshes/visual/finger.ply' Q:<-0 -0 -0 -0.707107 0 0 -0.707107>  visual, }
