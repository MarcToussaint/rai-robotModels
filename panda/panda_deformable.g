...
deform1(panda_link0>panda_joint1) { shape:marker, size:[.3] }
...
deform2(panda_link1>panda_joint2) { shape:marker, size:[.3] }
panda_link1_1(deform2) 	{  shape:mesh  mesh:'meshes/visual/link1.ply' Q:<d(-90 0 0 1) d(90 0 1 0)>  color:[.9 .9 .9] }
...
deform3(panda_link2>panda_joint3) { shape:marker, size:[.3] }
panda_link2_1(deform3) 	{  shape:mesh  mesh:'meshes/visual/link2.ply' Q:<d(90 0 0 1) t(0 .19 0) d(90 0 1 0)>  color:[.9 .9 .9] }
...
deform4(panda_link3>panda_joint4){ shape:marker, size:[.3] }
panda_link3_1(deform4) 	{  shape:mesh  mesh:'meshes/visual/link3.ply' Q:<d(90 0 0 1) t(0 0 .0825) d(90 0 1 0)>  color:[.9 .9 .9] }
...
deform5(panda_link4>panda_joint5) { shape:marker, size:[.3] }
panda_link4_1(deform5) 	{  shape:mesh  mesh:'meshes/visual/link4.ply' Q:<d(-90 0 0 1) t(0 -.13 -.0825) d(90 0 1 0)>  color:[.9 .9 .9] }
panda_joint5(deform5) 	{  joint:hingeX ctrl_H:1 limits=[  -2.8973 2.8973 2.61 12 1  ]  ctrl_limits:[ 2.61 12 1 ] }

panda_link5>panda_joint6(panda_joint5) 	{  shape:marker, size:[.3], Q:<0.254 0 0 -0.707107 0 0 0.707107> }
deform6(panda_link5>panda_joint6){ shape:marker, size:[.3] }
panda_link5_1(deform6) 	{  shape:mesh  mesh:'meshes/visual/link5.ply' Q:<d(90 0 0 1) d(90 0 1 0)>  color:[.9 .9 .9] }
