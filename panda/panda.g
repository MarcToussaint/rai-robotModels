...
frame panda_link7>panda_joint8(panda_joint7) 	{  Q:<0.107 0 2.37588e-17 -1 0 0 0> }
frame panda_joint8(panda_link7>panda_joint8) 	{  joint:rigid ctrl_H:1 }
frame panda_link8>panda_hand_joint(panda_joint8) 	{  Q:<-0 -0 -0 -0.653281 0.270598 -0.653281 0.270598> }
frame panda_hand_joint(panda_link8>panda_hand_joint) 	{  joint:rigid ctrl_H:1 }
frame panda_hand_1(panda_hand_joint) 	{  shape:mesh  mesh:'meshes/visual/hand_x.tri' }
frame panda_hand_0(panda_hand_joint) 	{  shape:mesh  color:[ 0.8 0.2 0.2 0.5 ]  mesh:'meshes/collision/hand.stl' contact,  }
...
frame panda_finger_joint2(panda_hand>panda_finger_joint2) 	{  joint:transX ctrl_H:1 limits=[  0 0.04 0.2 20 1  ] mimic:panda_finger_joint1  mimic:panda_finger_joint1  ctrl_limits:[ 0.2 20 1 ] }
