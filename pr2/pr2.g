...
coll_arm_r (r_upper_arm_roll_joint): { shape: ssBox, Q: [0.221337, 0, 0], size: [0.55, 0.201, 0.201, 0.1], contact: -5, coll_pr2, color: [1.,1.,1.,.2] }
coll_wrist_r (r_forearm_roll_joint): { shape: ssBox, Q: [0.21, 0, 0, 0.999391, 0, 0.0348995, 0], size: [0.35, 0.141, 0.141, 0.07], contact: -3, coll_pr2, color: [1.,1.,1.,.2] }
coll_hand_r (r_wrist_roll_joint): { shape: ssBox, Q: [0.12, 0, 0], size: [0.16, 0.12, 0.06, 0.025], contact: -3, coll_pr2, color: [1.,1.,1.,.2] }
coll_arm_l (l_upper_arm_roll_joint): { shape: ssBox, Q: [0.221337, 0, 0], size: [0.55, 0.201, 0.201, 0.1], contact: -5, coll_pr2, color: [1.,1.,1.,.2] }
coll_wrist_l (l_forearm_roll_joint): { shape: ssBox, Q: [0.21, 0, 0, 0.999391, 0, 0.0348995, 0], size: [0.35, 0.141, 0.141, 0.07], contact: -3, coll_pr2, color: [1.,1.,1.,.2] }
