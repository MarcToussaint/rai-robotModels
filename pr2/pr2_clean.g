...
base_link(base_footprint): { mass: 116, inertia: [5.65223, -0.00971993, 1.29399, 5.66947, -0.00737958, 3.6832] }
base_link_0(base_footprint): { shape: mesh, color: [0.8, 0.8, 0.8], mesh: 'meshes/base_v0/base.ply', visual: True }
base_laser_link(base_footprint): { mass: 0.001, inertia: [0.0001, 1e-06, 0.0001] }
base_laser_link_0(base_footprint): { shape: box, size: [0.001, 0.001, 0.001, 0], color: [0.8, 0.8, 0.8], visual: True }
base_link>fl_caster_rotation_joint(base_footprint): { rel: [0.2246, 0.2246, 0.0282, 1, 0, 0, 0] }
base_link>fr_caster_rotation_joint(base_footprint): { rel: [0.2246, -0.2246, 0.0282, 1, 0, 0, 0] }
base_link>bl_caster_rotation_joint(base_footprint): { rel: [-0.2246, 0.2246, 0.0282, 1, 0, 0, 0] }
base_link>br_caster_rotation_joint(base_footprint): { rel: [-0.2246, -0.2246, 0.0282, 1, 0, 0, 0] }
base_link>torso_lift_joint(base_footprint): { rel: [-0.05, 0, 0.739675, 1, 0, 0, 0] }
...
fl_caster_rotation_link>fl_caster_l_wheel_joint(fl_caster_rotation_joint): { rel: [0, 0.049, 0, 1, 0, 0, 0] }
fl_caster_rotation_link>fl_caster_r_wheel_joint(fl_caster_rotation_joint): { rel: [0, -0.049, 0, 1, 0, 0, 0] }
...
fr_caster_rotation_link>fr_caster_l_wheel_joint(fr_caster_rotation_joint): { rel: [0, 0.049, 0, 1, 0, 0, 0] }
fr_caster_rotation_link>fr_caster_r_wheel_joint(fr_caster_rotation_joint): { rel: [0, -0.049, 0, 1, 0, 0, 0] }
...
bl_caster_rotation_link>bl_caster_l_wheel_joint(bl_caster_rotation_joint): { rel: [0, 0.049, 0, 1, 0, 0, 0] }
bl_caster_rotation_link>bl_caster_r_wheel_joint(bl_caster_rotation_joint): { rel: [0, -0.049, 0, 1, 0, 0, 0] }
...
br_caster_rotation_link>br_caster_l_wheel_joint(br_caster_rotation_joint): { rel: [0, 0.049, 0, 1, 0, 0, 0] }
br_caster_rotation_link>br_caster_r_wheel_joint(br_caster_rotation_joint): { rel: [0, -0.049, 0, 1, 0, 0, 0] }
...
imu_link(torso_lift_joint): { mass: 0.001, inertia: [0.0001, 1e-06, 0.0001] }
imu_link_0(torso_lift_joint): { shape: box, size: [0.001, 0.001, 0.001, 0], color: [0.8, 0.8, 0.8], visual: True }
torso_lift_link>head_pan_joint(torso_lift_joint): { rel: [-0.01707, 0, 0.38145, 1, 0, 0, 0] }
torso_lift_link>laser_tilt_mount_joint(torso_lift_joint): { rel: [0.09893, 0, 0.227, 1, 0, 0, 0] }
torso_lift_link>r_shoulder_pan_joint(torso_lift_joint): { rel: [0, -0.188, 0, 1, 0, 0, 0] }
torso_lift_link>l_shoulder_pan_joint(torso_lift_joint): { rel: [0, 0.188, 0, 1, 0, 0, 0] }
...
head_pan_link>head_tilt_joint(head_pan_joint): { rel: [0.068, 0, 0, 1, 0, 0, 0] }
...
laser_tilt_link(laser_tilt_mount_joint): { mass: 0.001, inertia: [0.0001, 1e-06, 0.0001] }
laser_tilt_link_0(laser_tilt_mount_joint): { shape: box, size: [0.001, 0.001, 0.001, 0], color: [0.8, 0.8, 0.8], visual: True }
...
r_shoulder_pan_link>r_shoulder_lift_joint(r_shoulder_pan_joint): { rel: [0.1, 0, 0, 1, 0, 0, 0] }
...
l_shoulder_pan_link>l_shoulder_lift_joint(l_shoulder_pan_joint): { rel: [0.1, 0, 0, 1, 0, 0, 0] }
...
head_plate_frame(head_tilt_joint): { mass: 0.01, inertia: [0.001, 0.001, 0.001] }
head_plate_frame_0(head_tilt_joint): { shape: box, size: [0.01, 0.01, 0.01, 0], color: [0.8, 0.8, 0.8], visual: True }
sensor_mount_link(head_tilt_joint): { mass: 0.05, inertia: [0.001, 0.001, 0.01] }
sensor_mount_link_0(head_tilt_joint): { shape: box, size: [0.01, 0.01, 0.01, 0], color: [0.8, 0.8, 0.8], visual: True }
high_def_frame(head_tilt_joint): { mass: 0.01, inertia: [0.001, 0.001, 0.001] }
high_def_frame_0(head_tilt_joint): { rel: [-0.02, 0, 0, 1, 0, 0, 0], shape: box, size: [0.04, 0.04, 0.04, 0], color: [0.8, 0.8, 0.8], visual: True }
high_def_optical_frame(head_tilt_joint): { mass: 0.01, inertia: [0.001, 0.001, 0.001] }
high_def_optical_frame_0(head_tilt_joint): { rel: [0, 0, 0, 0.707107, 0, 0, 0.707107], shape: cylinder, size: [0, 0, 0.05, 0.02], color: [0.8, 0.8, 0.8], visual: True }
double_stereo_link(head_tilt_joint): { mass: 0.1, inertia: [0.001, 0.001, 0.01] }
double_stereo_link_0(head_tilt_joint): { rel: [-0.01, 0, 0.025, 1, 0, 0, 0], shape: box, size: [0.02, 0.12, 0.05, 0], color: [0.8, 0.8, 0.8], visual: True }
wide_stereo_link(head_tilt_joint): { mass: 0.1, inertia: [0.01, 0.01, 0.01] }
wide_stereo_link_0(head_tilt_joint): { shape: box, size: [0.001, 0.001, 0.001, 0], color: [0.8, 0.8, 0.8], visual: True }
wide_stereo_gazebo_l_stereo_camera_frame(head_tilt_joint): { mass: 0.01, inertia: [0.001, 0.001, 0.001] }
wide_stereo_gazebo_l_stereo_camera_frame_0(head_tilt_joint): { shape: box, size: [0.01, 0.01, 0.01, 0], color: [0.8, 0.8, 0.8], visual: True }
wide_stereo_gazebo_r_stereo_camera_frame(head_tilt_joint): { mass: 0.01, inertia: [0.001, 0.001, 0.001] }
wide_stereo_gazebo_r_stereo_camera_frame_0(head_tilt_joint): { shape: box, size: [0.01, 0.01, 0.01, 0], color: [0.8, 0.8, 0.8], visual: True }
narrow_stereo_link(head_tilt_joint): { mass: 0.1, inertia: [0.01, 0.01, 0.01] }
narrow_stereo_link_0(head_tilt_joint): { shape: box, size: [0.001, 0.001, 0.001, 0], color: [0.8, 0.8, 0.8], visual: True }
narrow_stereo_gazebo_l_stereo_camera_frame(head_tilt_joint): { mass: 0.01, inertia: [0.001, 0.001, 0.001] }
narrow_stereo_gazebo_l_stereo_camera_frame_0(head_tilt_joint): { shape: box, size: [0.01, 0.01, 0.01, 0], color: [0.8, 0.8, 0.8], visual: True }
narrow_stereo_gazebo_r_stereo_camera_frame(head_tilt_joint): { mass: 0.01, inertia: [0.001, 0.001, 0.001] }
narrow_stereo_gazebo_r_stereo_camera_frame_0(head_tilt_joint): { shape: box, size: [0.01, 0.01, 0.01, 0], color: [0.8, 0.8, 0.8], visual: True }
...
r_upper_arm_link>r_elbow_flex_joint(r_upper_arm_roll_joint): { rel: [0.4, 0, 0, 1, 0, 0, 0] }
...
l_upper_arm_link>l_elbow_flex_joint(l_upper_arm_roll_joint): { rel: [0.4, 0, 0, 1, 0, 0, 0] }
...
r_forearm_cam_frame(r_forearm_roll_joint): { mass: 0.01, inertia: [0.001, 0.001, 0.001] }
r_forearm_cam_frame_0(r_forearm_roll_joint): { shape: box, size: [0.01, 0.01, 0.01, 0], color: [0.8, 0.8, 0.8], visual: True }
r_forearm_link>r_wrist_flex_joint(r_forearm_roll_joint): { rel: [0.321, 0, 0, 1, 0, 0, 0] }
...
l_forearm_cam_frame(l_forearm_roll_joint): { mass: 0.01, inertia: [0.001, 0.001, 0.001] }
l_forearm_cam_frame_0(l_forearm_roll_joint): { shape: box, size: [0.01, 0.01, 0.01, 0], color: [0.8, 0.8, 0.8], visual: True }
l_forearm_link>l_wrist_flex_joint(l_forearm_roll_joint): { rel: [0.321, 0, 0, 1, 0, 0, 0] }
...
r_gripper_palm_link>r_gripper_l_finger_joint(r_wrist_roll_joint): { rel: [0.07691, 0.01, 0, 1, 0, 0, 0] }
r_gripper_palm_link>r_gripper_r_finger_joint(r_wrist_roll_joint): { rel: [0.07691, -0.01, 0, 1, 0, 0, 0] }
r_gripper_palm_link>r_gripper_l_parallel_root_joint(r_wrist_roll_joint): { rel: [0.05891, 0.031, 0, 1, 0, 0, 0] }
r_gripper_palm_link>r_gripper_r_parallel_root_joint(r_wrist_roll_joint): { rel: [0.05891, -0.031, 0, 1, 0, 0, 0] }
...
l_gripper_palm_link>l_gripper_l_finger_joint(l_wrist_roll_joint): { rel: [0.07691, 0.01, 0, 1, 0, 0, 0] }
l_gripper_palm_link>l_gripper_r_finger_joint(l_wrist_roll_joint): { rel: [0.07691, -0.01, 0, 1, 0, 0, 0] }
l_gripper_palm_link>l_gripper_l_parallel_root_joint(l_wrist_roll_joint): { rel: [0.05891, 0.031, 0, 1, 0, 0, 0] }
l_gripper_palm_link>l_gripper_r_parallel_root_joint(l_wrist_roll_joint): { rel: [0.05891, -0.031, 0, 1, 0, 0, 0] }
...
r_gripper_l_finger_link>r_gripper_l_finger_tip_joint(r_gripper_l_finger_joint): { rel: [0.09137, 0.00495, 0, 1, 0, 0, 0] }
...
r_gripper_r_finger_link>r_gripper_r_finger_tip_joint(r_gripper_r_finger_joint): { rel: [0.09137, -0.00495, 0, 1, 0, 0, 0] }
...
l_gripper_l_finger_link>l_gripper_l_finger_tip_joint(l_gripper_l_finger_joint): { rel: [0.09137, 0.00495, 0, 1, 0, 0, 0] }
...
l_gripper_r_finger_link>l_gripper_r_finger_tip_joint(l_gripper_r_finger_joint): { rel: [0.09137, -0.00495, 0, 1, 0, 0, 0] }
