...
beam22(joint1b): { Q: [0, 0, 0.05], shape: ssBox, size: [0.06, 0.06, 0.1, 0.01], color: [1], contact: -1 },
joint2A(joint1b): { Q: [0 0 .1] },
...
joint4a(joint3b): { Q: [0, 0, -0.1] },
joint4b(joint4a): { joint: hingeZ, limits: [-3, 3], shape: marker, size:[.02] }

gripperB(joint4b): { Q: "d(180 0 1 0) t(0 0 .08)", shape: marker, size: [.03], color: [.9, .9, .9], logical: { is_gripper } }
